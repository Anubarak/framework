        ...
        _createClass(e, [{
            ...
            value: function e(t) {
                ...
                if (t.dataTransfer && t.dataTransfer.files && t.dataTransfer.files.length) {
                    ...
                    this.readFiles(t.dataTransfer.files, this.upload.bind(this), this.insert.bind(this))
                }
            }
        }, {
            key: "handlePaste",
            ...
            key: "upload",
            value: function e(base64, c) {
                const fd = new FormData();
                fd.append('image', base64);
                fd.append('action', "asset/storeAssetFromB64");
                 ...
                 xhr.onload = function(){
                        if (xhr.status === 200) {
                            ...
                            const data = JSON.parse(xhr.responseText).url;
                            //callback auf insert
                            c(data);
                        }
                    };
